export default function ProductCard({ name, price, imageUrl }) {
  return (
    <article className="rounded-xl border border-brand-border bg-brand-surface shadow-soft overflow-hidden transition-colors duration-500">
      ...
      <div className="aspect-[3/4] bg-[color:var(--color-surface)] overflow-hidden">
        <img
          src={imageUrl}
          alt={name}
      ...
      <div className="p-4 transition-colors duration-500">
        ...
        <p className="mt-1 text-sm text-brand-textMuted transition-colors duration-500">
          Eau de parfum
        </p>
        <div className="mt-4 flex items-center justify-between">
          ...
          <button className="px-4 py-2 rounded-full border border-brand-border text-brand-text hover:bg-brand-surface/60 transition-colors duration-500">
            Adicionar
          </button>
        </div>
      </div>
